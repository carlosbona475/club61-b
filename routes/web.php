...
return [
    ...
    'routes' => [
        ...
        'GET /features/chat/inbox.php' => ['middleware' => 'auth', 'action' => [LegacyController::class, 'chatInbox']],
        'GET /chat/dm' => ['middleware' => 'auth', 'action' => [LegacyController::class, 'chatDm']],
        'GET /features/chat/dm.php' => ['middleware' => 'auth', 'action' => [LegacyController::class, 'chatDm']],
        'GET /explore/nearby' => ['middleware' => 'auth', 'action' => [LegacyController::class, 'exploreNearby']],
        'GET /features/explore/nearby.php' => ['middleware' => 'auth', 'action' => [LegacyController::class, 'exploreNearby']],
        'GET /stories/view' => ['middleware' => 'auth', 'action' => [LegacyController::class, 'storiesView']],
        'GET /features/stories/view.php' => ['middleware' => 'auth', 'action' => [LegacyController::class, 'storiesView']],
    ],
];